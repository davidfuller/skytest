  ...
  def create
    ...
    respond_to do |format|
      if @channel_type.save
        format.html { redirect_to @channel_type, notice: 'Channel type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @channel_type.update(channel_type_params)
        format.html { redirect_to @channel_type, notice: 'Channel type was successfully updated.' }
